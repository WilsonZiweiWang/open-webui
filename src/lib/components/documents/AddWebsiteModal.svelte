<script lang="ts">
	...
	let uploadWebsiteInputElement: HTMLInputElement;
	let tags = [];

	const submitHandler = async () => {
		// Check if URL is valid?
		// if valid, upload website
		console.log('upload url: ', uploadWebsiteInputElement.value);
		uploadWebsite(uploadWebsiteInputElement.value, tags)
		// loop each url and upload

		uploadWebsiteInputElement.value = '';
				...
				>
					<div class="mb-3 w-full">
						<input
							...
							bind:this={uploadWebsiteInputElement}
